...
import com.aszz.cert.admin.dao.TaskDao;
import com.aszz.cert.admin.quartz.QuartzException;
...
public class TaskServiceImpl implements ITaskService {
    ...
    public TaskEntity findByTaskName(String jobName) {
        return taskDao.findByTaskName(jobName);
