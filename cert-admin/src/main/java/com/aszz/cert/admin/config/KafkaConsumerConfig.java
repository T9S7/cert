...
public class KafkaConsumerConfig {
    ...
    public Map<String, Object> consumerCarConfigs() {
        ...
        propsMap.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, keyDeserialize);
        propsMap.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, valDeserialize);
